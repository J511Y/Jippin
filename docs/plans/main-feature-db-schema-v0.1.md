...
- `chat_messages`, `chat_tool_calls`, `analysis_runs`, `overlay_selections`, `flow_guard_decisions`, `rule_evaluations`, `reports`: `sessions.user_id` 를 통해 owner 확인.
