...
const SECTIONS: Section[] = [
  {
    ...
    body: (
      <Stack gap="xs">
        <Para>
          집핀(Jippin, 이하 &lsquo;회사&rsquo;)은 다음의 목적을 위하여 개인정보를
          처리하며, 처리한 개인정보는 다음의 목적 이외의 용도로는 이용하지
          않습니다.
        </Para>
        <Clause marker="가.">
    ...
    <Stack gap="xl">
      <Stack gap="xs">
        ...
        <Text c="dimmed" size="sm" style={KEEP_ALL}>
          집핀(Jippin, 이하 &lsquo;회사&rsquo;)은 이용자의 개인정보를 중요하게
          생각하며, 「개인정보 보호법」 등 관계 법령을 준수합니다. 본
          개인정보처리방침은 회사가 제공하는 비내력벽 철거 AI 사전검토 및 전문가
