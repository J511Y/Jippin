    ...
    articles: [
      {
        ...
        body: (
          <Para>
            본 약관은 집핀(Jippin, 이하 &lsquo;회사&rsquo;)이 제공하는 비내력벽
            철거 사전검토 AI 서비스 및 전문가 상담 연결 서비스(이하
    ...
    <Stack gap="xl">
      <Stack gap="xs">
        ...
        <Text c="dimmed" size="sm" style={KEEP_ALL}>
          본 약관은 집핀(Jippin)이 제공하는 비내력벽 철거 사전검토 AI 서비스 및
          전문가 상담 연결 서비스의 이용에 관한 조건과 절차를 정합니다. 약관은
